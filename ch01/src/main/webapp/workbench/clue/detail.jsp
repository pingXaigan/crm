...
<script type="text/javascript">
	...
	$(function(){
        ...
        // 为关联市场活动中的搜索框绑定事件，通过触发回车键，查询并展现市场活动列表
		$("#aname").keydown(function (event) {
			if(event.keyCode == 13){
				...
				// 查询并展现市场活动列表
				$.ajax({
					url : "workbench/clue/getActivityListByNameAndNoAssociateByClueId.do",
					data : {
		...
		$("#bundBtn").click(function () {
			...
			if($xz.length==0) {alert("请选择需要关联的市场活动");}
			else{
